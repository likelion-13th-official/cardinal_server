...
-- (1, '멋쟁이토마토', 'https://example.com/profile1.jpg'),
-- (2, '해피코더', 'https://example.com/profile2.jpg'),
-- (3, '코딩마법사', 'https://example.com/profile3.jpg'),
-- (4, '개발왕김개발', 'https://example.com/profile4.jpg'),
-- (5, '알고리즘귀재', 'https://example.com/profile5.jpg'),
-- (6, '데이터분석가', 'https://example.com/profile6.jpg'),
-- (7, '자바신', 'https://example.com/profile7.jpg'),
-- (8, '파이썬사랑', 'https://example.com/profile8.jpg'),
-- (9, '리액트장인', 'https://example.com/profile9.jpg'),
-- (10, '뷰마스터', 'https://example.com/profile10.jpg'),
-- (11, '노드고수', 'https://example.com/profile11.jpg'),
-- (12, '스프링달인', 'https://example.com/profile12.jpg'),
-- (13, '장고천재', 'https://example.com/profile13.jpg'),
-- (14, '플러터개발자', 'https://example.com/profile14.jpg'),
-- (15, '스위프트마스터', 'https://example.com/profile15.jpg'),
-- (16, '코틀린사랑', 'https://example.com/profile16.jpg'),
-- (17, '게임개발자', 'https://example.com/profile17.jpg'),
-- (18, '머신러닝전문가', 'https://example.com/profile18.jpg'),
-- (19, '딥러닝연구원', 'https://example.com/profile19.jpg'),
-- (20, '블록체인개발자', 'https://example.com/profile20.jpg');

-- -- 2. Map (10 records)
-- INSERT INTO map (id, position, latitude, longitude) VALUES
-- (1, '학생회관 앞', 37.5833, 127.0001),
-- (2, '중앙광장', 37.5838, 127.0005),
-- (3, '도서관 옆 잔디밭', 37.5842, 126.9998),
-- (4, '공학관 1층 로비', 37.5829, 127.0010),
-- (5, '인문관 벤치', 37.5835, 126.9990),
-- (6, '대운동장', 37.5850, 127.0020),
-- (7, '정문', 37.5820, 126.9980),
-- (8, '후문', 37.5860, 127.0030),
-- (9, '기숙사 식당 앞', 37.5810, 127.0015),
-- (10, '체육관 입구', 37.5845, 127.0018);
...
--  -- ALTER TABLE event DROP CONSTRAINT event_location_id_key;
-- -- 5. Events (10 records)
-- INSERT INTO event (id, name, location_id, description, thumbnail_url, view_count, day_of_week, start_time, end_time, is_operating) VALUES
--  (1, '개막식', 2, '축제의 시작을 알리는 개막식', 'https://example.com/event1.jpg', 5000, '금', '2025-08-16 10:00:00', '2025-08-16 12:00:00', true),
-- (2, '특별 강연: 실리콘밸리 개발자의 삶', 4, '실리콘밸리에서 일하는 개발자의 생생한 이야기', 'https://example.com/event2.jpg', 4500, '금', '2025-08-16 14:00:00', '2025-08-16 16:00:00', true),
-- (3, 'DJ 파티', 6, '코딩보다 신나는 DJ 파티!', 'https://example.com/event3.jpg', 6000, '금', '2025-08-16 20:00:00', '2025-08-17 00:00:00', true),
-- (4, '보물찾기 이벤트', 2, '축제 곳곳에 숨겨진 보물을 찾아라!', 'https://example.com/event4.jpg', 7000, '상시', '2025-08-17 10:00:00', '2025-08-17 18:00:00', true),
-- (5, '코스프레 대회', 6, '최고의 개발자 코스프레는 누구?', 'https://example.com/event5.jpg', 5500, '상시', '2025-08-17 14:00:00', '2025-08-17 16:00:00', true),
-- (6, '네트워킹 파티', 1, '다양한 개발자들과 교류할 수 있는 기회', 'https://example.com/event6.jpg', 6500, '상시', '2025-08-17 18:00:00', '2025-08-17 20:00:00', true),
-- (7, '경품 추첨', 2, '축제의 마지막을 장식할 경품 추첨', 'https://example.com/event7.jpg', 8000, '상시', '2025-08-18 16:00:00', '2025-08-18 17:00:00', true),
-- (8, '폐막식', 6, '아쉬운 축제의 마무리', 'https://example.com/event8.jpg', 4000, '상시', '2025-08-18 18:00:00', '2025-08-18 20:00:00', true),
-- (9, '인디밴드 공연', 3, '감성적인 인디밴드의 라이브 공연', 'https://example.com/event9.jpg', 3000, '금', '2025-08-16 17:00:00', '2025-08-16 19:00:00', true),
-- (10, '마술쇼', 5, '코딩처럼 신기한 마술의 세계', 'https://example.com/event10.jpg', 3500, '상시', '2025-08-17 13:00:00', '2025-08-17 14:00:00', true);
...
-- (10,9, 'https://example.com/event9_detail1.jpg');

-- -- 7. Goods (10 records)
-- INSERT INTO goods (id, name, description, thumbnail_url, view_count, location_id) VALUES
-- (1, '개발자 티셔츠', 'I speak fluent Java', 'https://example.com/goods1.jpg', 1500, 4),
-- (2, '코딩 머그컵', 'Keep Calm and Code On', 'https://example.com/goods2.jpg', 2000, 4),
-- (3, '알고리즘 노트', '알고리즘 문제 풀이에 최적화된 노트', 'https://example.com/goods3.jpg', 1800, 5),
-- (4, '버그 인형', '스트레스 해소용 버그 인형', 'https://example.com/goods4.jpg', 2500, 5),
-- (5, '해커 키보드', '해커처럼 빠른 타이핑을 위한 기계식 키보드', 'https://example.com/goods5.jpg', 3000, 4),
-- (6, '개발자 스티커팩', '노트북을 꾸밀 수 있는 다양한 개발자 스티커', 'https://example.com/goods6.jpg', 2200, 4),
-- (7, '코딩 양말', '코딩할 때 신으면 집중력이 올라가는 양말', 'https://example.com/goods7.jpg', 1700, 5),
-- (8, '알고리즘 마우스패드', '알고리즘 문제 풀 때 유용한 마우스패드', 'https://example.com/goods8.jpg', 1900, 5),
-- (9, '버그 스프레이', '버그를 한 방에 해결해주는 상상 속의 스프레이', 'https://example.com/goods9.jpg', 2800, 4),
-- (10, '해커 후드티', '해커처럼 보이고 싶을 때 입는 후드티', 'https://example.com/goods10.jpg', 3200, 4);
...
-- INSERT INTO performance (id, category, name, date, description, thumbnail_url, view_count, location_id) VALUES
-- (1, '동아리', '멋쟁이사자처럼 노래패', '2025-08-16 13:00:00', '멋쟁이사자처럼 멤버들이 부르는 감미로운 노래', 'https://example.com/perf1.jpg', 1200, 2),
-- (2, '동아리', '코딩댄스팀', '2025-08-16 15:00:00', '코딩 동작을 응용한 신나는 댄스 공연', 'https://example.com/perf2.jpg', 1500, 6),
-- (3, '동아리', '알고리즘 연극반', '2025-08-17 11:00:00', '알고리즘을 주제로 한 재미있는 연극', 'https://example.com/perf3.jpg', 1300, 3),
-- (4, '동아리', '버그 버스킹', '2025-08-17 17:00:00', '버그 잡는 심정으로 부르는 애절한 발라드', 'https://example.com/perf4.jpg', 1800, 5),
-- (5, '동아리', '해커 밴드', '2025-08-18 13:00:00', '해커들의 열정이 느껴지는 락밴드 공연', 'https://example.com/perf5.jpg', 2000, 6),
-- (6, '동아리', '코딩 오케스트라', '2025-08-18 15:00:00', '코딩처럼 정교하고 아름다운 오케스트라 연주', 'https://example.com/perf6.jpg', 1600, 2),
-- (7, '영화제', '개발자의 사랑', '2025-08-16 19:00:00', '개발자의 애틋한 사랑 이야기를 담은 단편 영화', 'https://example.com/perf7.jpg', 2500, 4),
-- (8, '영화제', '알고리즘의 눈물', '2025-08-17 19:00:00', '알고리즘에 울고 웃는 개발자들의 이야기', 'https://example.com/perf8.jpg', 2200, 4),
-- (9, '영화제', '버그와의 전쟁', '2025-08-18 19:00:00', '버그를 잡기 위한 개발자들의 처절한 사투', 'https://example.com/perf9.jpg', 2800, 4),
-- (10, '영화제', '해커의 꿈', '2025-08-16 21:00:00', '세상을 바꾸고 싶은 해커의 이야기', 'https://example.com/perf10.jpg', 3000, 4),
-- (11, '영화제', '코딩의 신', '2025-08-17 21:00:00', '전설적인 코더의 일대기를 그린 영화', 'https://example.com/perf11.jpg', 3200, 4),
-- (12, '영화제', 'AI의 역습', '2025-08-18 21:00:00', '인공지능이 인류를 위협하는 SF 스릴러', 'https://example.com/perf12.jpg', 3500, 4),
-- (13, '아티스트', '아이유', '2025-08-16 22:00:00', '국민 여동생 아이유의 특별 공연', 'https://example.com/perf13.jpg', 10000, 6),
-- (14, '아티스트', '악동뮤지션', '2025-08-17 22:00:00', '악동뮤지션의 재치있는 무대', 'https://example.com/perf14.jpg', 9000, 6),
-- (15, '아티스트', '10cm', '2025-08-18 22:00:00', '10cm의 감미로운 목소리', 'https://example.com/perf15.jpg', 8000, 6),
-- (16, '아티스트', '볼빨간사춘기', '2025-08-16 18:00:00', '볼빨간사춘기의 상큼한 공연', 'https://example.com/perf16.jpg', 7000, 2),
-- (17, '아티스트', '자이언티', '2025-08-17 18:00:00', '자이언티의 독특한 음색', 'https://example.com/perf17.jpg', 7500, 2),
-- (18, '아티스트', '크러쉬', '2025-08-18 18:00:00', '크러쉬의 감성적인 R&B 무대', 'https://example.com/perf18.jpg', 8500, 2),
-- (19, '아티스트', '헤이즈', '2025-08-17 20:00:00', '비오는 날 듣기 좋은 헤이즈의 노래', 'https://example.com/perf19.jpg', 9500, 6),
-- (20, '아티스트', '폴킴', '2025-08-18 20:00:00', '고막남친 폴킴의 달달한 라이브', 'https://example.com/perf20.jpg', 9200, 6);
...
-- (1, 181, '부스', '2025-08-16 19:00:00'),
-- (1, 13, '이벤트', '2025-08-16 23:00:00'),
-- (2, 6, '공연', '2025-08-16 13:00:00'),
-- (2, 3, '굿즈', '2025-08-16 21:00:00'),
-- (3, 182, '부스', '2025-08-17 10:00:00'),
-- (4, 182, '부스', '2025-08-17 11:00:00'),
-- (5, 7, '공연', '2025-08-17 19:30:00'),
-- (6, 4, '이벤트', '2025-08-18 12:00:00'),
-- (7, 182, '부스', '2025-08-18 14:00:00'),
