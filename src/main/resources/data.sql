...
INSERT INTO booth (booth_type, category, name, location_id, description, thumbnail_url, view_count, start_time, end_time, is_operating, notice, instagram_url, menu_image_url, table_layout_url, notice_updated_at) VALUES
('주점', 'PUB', '코딩 주점', 6, '코딩하며 즐기는 신개념 주점!', 'https://example.com/booth1.jpg', 150, '18:00:00', '02:00:00', true, '신분증 필수 지참!', 'https://instagram.com/coding_pub', 'https://example.com/pub_menu1.jpg', 'https://example.com/pub_layout1.jpg','2025-08-18 22:00:00'),
('주점', 'PUB', '개발자들의 쉼터', 6, '지친 개발자들을 위한 힐링 공간', 'https://example.com/booth2.jpg', 250, '17:00:00', '01:00:00', true, '외부 안주 반입 금지', 'https://instagram.com/dev_rest', 'https://example.com/pub_menu2.jpg', 'https://example.com/pub_layout2.jpg','2025-08-18 22:00:00'),
('주점', 'PUB', '알고리즘 파티', 6, '알고리즘 문제 풀고, 술도 마시고!', 'https://example.com/booth3.jpg', 180, '19:00:00', '03:00:00', true, '팀 대항전 이벤트 진행!', 'https://instagram.com/algo_party', 'https://example.com/pub_menu3.jpg', 'https://example.com/pub_layout1.jpg','2025-08-18 22:00:00'),
('주점', 'PUB', '버그 사냥꾼', 6, '버그 잡고 스트레스 풀자!', 'https://example.com/booth4.jpg', 320, '18:00:00', '02:00:00', true, '현금 결제만 가능합니다', 'https://instagram.com/bug_hunter', 'https://example.com/pub_menu4.jpg', 'https://example.com/pub_layout4.jpg','2025-08-18 22:00:00'),
('주점', 'PUB', '해커들의 밤', 6, '해커톤보다 재미있는 해커들의 주점', 'https://example.com/booth5.jpg', 450, '20:00:00', '04:00:00', false, '일요일은 쉽니다', 'https://instagram.com/hackers_night', 'https://example.com/pub_menu5.jpg', 'https://example.com/pub_layout1.jpg','2025-08-18 22:00:00');

-- FoodTruckBooth (5)
-- 'start_time'과 'end_time'이 'HH:MM:SS' 형식으로 변경
INSERT INTO booth (booth_type, category, name, location_id, description, thumbnail_url, view_count, start_time, end_time, is_operating, menu_image_url) VALUES
('푸드트럭', 'FOOD_TRUCK', '코딩푸드', 6, '코더들을 위한 맛있는 간식!', 'https://example.com/booth6.jpg', 500, '12:00:00', '22:00:00', true, 'https://example.com/food_menu1.jpg'),
('푸드트럭', 'FOOD_TRUCK', '개발자 핫도그', 7, '세상에서 제일 맛있는 핫도그', 'https://example.com/booth7.jpg', 380, '11:00:00', '21:00:00', true, 'https://example.com/food_menu2.jpg'),
('푸드트럭', 'FOOD_TRUCK', '알고리즘 츄러스', 8, '달콤한 츄러스와 함께하는 알고리즘', 'https://example.com/booth8.jpg', 420, '13:00:00', '23:00:00', true, 'https://example.com/food_menu3.jpg'),
('푸드트럭', 'FOOD_TRUCK', '버그와플', 9, '버그처럼 달콤한 와플', 'https://example.com/booth9.jpg', 280, '12:00:00', '22:00:00', true, 'https://example.com/food_menu4.jpg'),
('푸드트럭', 'FOOD_TRUCK', '해커스테이크', 10, '해커처럼 강력한 스테이크', 'https://example.com/booth10.jpg', 600, '14:00:00', '23:00:00', true, 'https://example.com/food_menu5.jpg');
...
-- 'start_time'과 'end_time'이 'HH:MM:SS' 형식으로 변경
INSERT INTO booth (booth_type, category, name, location_id, description, thumbnail_url, view_count, start_time, end_time, is_operating) VALUES
('포토부스', 'PHOTO_BOOTH', '인생샷 연구소', 5, '개발자 컨셉의 인생샷을 찍어보세요', 'https://example.com/booth16.jpg', 1200, '10:00:00', '22:00:00', true),
...
-- 4-1. Booths 운영 요일 데이터 삽입
-- (부스 ID는 1부터 30까지 순서대로 할당된다고 가정)
INSERT INTO booth_operating_days (booth_id, operating_days) VALUES
(1, 'FRI'), -- 코딩 주점
(2, 'FRI'), -- 개발자들의 쉼터
(3, 'ALWAYS'), -- 알고리즘 파티
(4, 'ALWAYS'), -- 버그 사냥꾼
...
ALTER TABLE event DROP CONSTRAINT IF EXISTS event_location_id_key;
 ...
 -- 6. Events (10 records)
-- 'start_time'과 'end_time'이 'HH:MM:SS' 형식으로 변경
INSERT INTO event (name, location_id, description, thumbnail_url, view_count, start_time, end_time, is_operating) VALUES
('DJ 파티', 6, '코딩보다 신나는 DJ 파티!', 'https://example.com/event3.jpg', 6000, '20:00:00', '00:00:00', true),
...
INSERT INTO event_operating_days (event_id, operating_days) VALUES
(1, 'FRI'), -- DJ 파티
(2, 'ALWAYS'), -- 보물찾기 이벤트
(3, 'ALWAYS'), -- 코스프레 대회
(4, 'ALWAYS'), -- 네트워킹 파티
...
('CLUB', '멋쟁이사자처럼 노래패', '2025-08-16 13:00:00', '멋쟁이사자처럼 멤버들이 부르는 감미로운 노래', 'https://example.com/perf1.jpg', 1200, 6),
